    ...
    <div class="column items-center swipe-root">
        ...
        <div class="row justify-center q-mt-md swipe-row">
            ...
            <div class="swipe-container" ref="swipeContainer">
                ...
                <!-- THUMB -->
                <div class="swipe-thumb" :class="{ disabled: !enabled }"
                    :style="{ transform: `translateX(${swipeX}px)` }" @mousedown="enabled && startSwipe($event)"
                    @touchstart="enabled && startSwipe($event)">
