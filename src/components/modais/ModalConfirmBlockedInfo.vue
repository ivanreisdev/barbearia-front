    ...
    <q-dialog v-model="inner" persistent>
        <q-card class="blocked-modal-card">
            <q-card-section class="q-pa-md text-center">
                ...
                <div class="blocked-title">Confirmação temporariamente bloqueada</div>
                <div class="blocked-desc">
                    Detectamos um número elevado de tentativas de confirmação. Por motivos de segurança, a validação de
                    códigos foi temporariamente suspensa.
                </div>
...
const props = defineProps({
    ...
    timerText: { type: String, default: '00:00:00' },
})
